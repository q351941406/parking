    ...
    <div data-theme="cupcake" class="bg-base-100">
        <div class="navbar shadow-sm">
            <div class="flex-none">
                ...
                <button class="btn btn-sm " onclick="alert('目前仅开通成都市');">成都
            ...
            <div class="flex-1">
                ...
                <div class="badge badge-secondary badge-lg ml-0" @click="goProfile">{{ $store.state.userInfo &&
                    $store.state.userInfo.phone || '请登录' }}</div>
            </div>
        ...
        <div class="flex justify-center">
            ...
            <div
                ...
                <div v-for="(item, index) in data" :key="index" class="card w-full shadow-xl">
                    ...
                    <div class="card-body ">
                        <h2 class="card-title text-sm">{{ item.title }}
                            <!-- <div class="badge badge-secondary">新</div> -->
                        </h2>
                        <p class="text-xs">距离机场约9分钟车程</p>

                        <div class="card-actions justify-end">
                            <div v-for="tag in item.tag" :key="tag" class="badge badge-accent badge-outline badge-sm">{{
                                tag.title }}
                            </div>
